@php
    ...
    $heroSubtitle = \App\Models\SiteSetting::get('pricing_hero_subtitle', 'Scale with Confidence');
    $heroTitle = \App\Models\SiteSetting::get('pricing_hero_title', 'Choose Your Growth Plan');
    $heroDesc = \App\Models\SiteSetting::get('pricing_hero_desc', 'Predictable pricing for every stage of your laboratory\'s growth. No hidden fees.');
    $faqTitle = \App\Models\SiteSetting::get('pricing_faq_title', 'Pricing Questions');
    $ctaTitle = \App\Models\SiteSetting::get('pricing_cta_title', 'Upgrade Your Diagnostic Intelligence');
    $ctaDesc = \App\Models\SiteSetting::get('pricing_cta_desc', 'Start your free trial today. No credit card required.');
@endphp

...
<body>
    ...
    <div class="end-note">
        This is an official document generated by {{ ($invoice->branch && $invoice->branch->name) ? $invoice->branch->name : $company->name }}. Use the QR code for instant digital verification.

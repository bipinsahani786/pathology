                        ...
                        <div class="modal-body p-4 bg-white">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center justify-content-between p-3 border rounded-3 bg-light">
                                        <div>
                                            <div class="fw-bold text-dark fs-12">WhatsApp Custom Messages</div>
                                            <div class="text-muted fs-10">Allow lab to customize WhatsApp sharing messages</div>
                                        </div>
                                        <div class="form-check form-switch m-0">
                                            <input class="form-check-input" type="checkbox" wire:model="has_whatsapp_custom">
                                        </div>
                                    </div>
                                </div>
                            </div>

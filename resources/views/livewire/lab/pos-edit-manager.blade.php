                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="p-2 rounded-3 bg-gray-100 border mb-2">
                            ...
                            <div class="mt-2">
                                ...
                                <input type="text" list="posEditDiscountReasons" class="form-control form-control-sm fs-11" wire:model="discount_remarks" placeholder="Reason for discount (e.g. Doctor ref, Staff, VIP)">
                                <datalist id="posEditDiscountReasons">

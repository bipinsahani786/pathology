                                ...
                                <tr wire:key="doctor-{{ $doctor->id }}" class="border-bottom border-light">
                                    ...
                                    <td class="text-center pe-4">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            @endcan
                                            @can('edit doctors')
                                                <a href="{{ route('lab.doctor.commissions', $doctor->id) }}" wire:navigate class="btn btn-sm btn-light border text-success shadow-sm rounded align-center-btn transition-all hover-success" title="Set Test Commissions">
                ...
                <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="modal-header bg-white border-bottom p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="modal-title fw-bold text-dark mb-0">Bulk Doctor Import from Excel</h5>
                                <p class="text-muted fs-12 mb-0">Upload an Excel (.xlsx, .xls) or CSV (.csv) file to import multiple referring doctors.</p>
                            </div>
                        </div>
                    ...
                    <div class="modal-body p-4 bg-white">
                        ...
                        <div class="p-3 mb-4 rounded-3 border border-primary border-opacity-25 bg-soft-primary d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                            <div>
                                <div class="fw-bold text-primary fs-14 mb-1">
                                    <i class="feather-download me-1"></i> Need a doctor template?
                                </div>
                                <div class="text-muted fs-12">
                                    Download our pre-formatted Excel template with sample referring doctor records.
                                </div>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="border border-2 border-dashed rounded-4 p-4 text-center bg-light position-relative">
                                <input type="file" wire:model="importFile" accept=".xlsx,.xls,.csv" class="position-absolute top-0 start-0 w-100 h-100 opacity-0 cursor-pointer" id="excelDoctorFile">
                                ...
                                <div wire:loading.remove wire:target="importFile" class="d-flex flex-column align-items-center">
                                    ...
                                    @else
                                        ...
                                        <label for="excelDoctorFile" class="btn btn-outline-primary btn-sm px-4 shadow-sm cursor-pointer">
                                    ...
                                    <table class="table table-sm table-bordered bg-white fs-11 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>e.g. Dr. Rajesh Verma (prefix Dr. is auto-added if omitted)</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge bg-secondary">Optional</span></td>
                                                <td>e.g. Cardiologist, General Physician</td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold">Clinic Name</td>
                                                <td><span class="badge bg-secondary">Optional</span></td>
                                                <td>e.g. City Health Clinic</td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold">Commission %</td>
                                                <td><span class="badge bg-secondary">Optional</span></td>
                                                <td>0 to 100 (e.g. 15 for 15%)</td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="modal-footer bg-light border-top p-3 d-flex justify-content-end gap-2">
                        ...
                        <button type="button" wire:click="processBulkImport" wire:loading.attr="disabled" class="btn btn-success px-5 fw-bold shadow-sm d-flex align-items-center">
                            ...
                            <div wire:loading wire:target="processBulkImport"><span class="spinner-border spinner-border-sm me-2" role="status"></span> Importing Doctors...</div>
                        </button>
                    </div>
                </div>
            </div>
